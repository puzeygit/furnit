...
function toggleClassMenu() {
    menu.forEach(elem => elem.classList.toggle('menu--open'));
}

headerBtnMenu.addEventListener('click', toggleClassMenu);
...
const $measurements = document.querySelector('.works-path__item--measurements');
const $consultation = document.querySelector('.works-path__item--consultation');
const $itemBox = document.querySelector('.works-path__items-box');
const $body = document.body;

$body.onresize = function () {
    if ($body.offsetWidth < 651) $consultation.after($measurements);
    else{
        $itemBox.after($measurements)
    }
}
...
$('.article-slider__box').slick({
  prevArrow: '<button type="button" class="article-slider__arrow article-slider__arrowleft"><img src="img/svg/arrow-slide-left.svg"></button>',
  nextArrow: '<button type="button" class="article-slider__arrow article-slider__arrowright"><img src="img/svg/arrow-slide-right.svg"></button>',
});
